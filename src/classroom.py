...
class Classroom:
    ...
    def update(self, bboxes: np.ndarray) -> None:
        ...
        for i, student in enumerate(self.students):
            ...
            x1, y1, x2, y2 = max(0, xmin - 10), max(0, ymin - 10), min(640, xamx + 10), min(360, ymax + 10)
            # 找出与感兴趣区域有交集的检测框
        ...
        for i, bbox in enumerate(unassigned_bboxes):
            ...
            interested_area = self.id_map[max(0, ymin - 10):min(360, ymax + 10), max(0, xmin - 10):min(640, xamx + 10)]
